            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <form class="form-inline mt-2 mr-3 mt-md-0 d-none d-sm-block">
            ...
            <div class="col-lg-5 side-left">
              <div class="card mb-4">
                <div class="card-body avatar">
                  ...
                  <p class="batch"> {{ $user->department_name }}, {{ $user->batch_name }}</p>
                </div>
              </div>
              <div class="card mb-4">
                            <div class="card-body overview">
                                ...
                                <div class="wrapper about-user">
                                    <h2 class="card-title mt-4 mb-3">Linked Accounts</h2>
                                    <div class="social-media">
                                        <a href="#">
                                            <i class="fa fa-plus"> Facebook</i>
                                        </a>
                                        <a href="#">
                                            <i class="fa fa-plus"> Linkedin</i>
                                        </a>
                                    </div>
                                </div>
                            </div>
          ...
          <div class="modal-body">
            <form action="{{ url('/user_introduction') }}" method="post">
              {{csrf_field() }}
                ...
                <div class="form-group">
                  <label for="education">Designation</label>
                  <input type="text" class="form-control" name="designation" placeholder="Write your Designation" required=""/>
              </div>
                <div class="form-group">
